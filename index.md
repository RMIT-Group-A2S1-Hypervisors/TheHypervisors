...
<br>
  ...
  <p>Unity offers developers a platform to create 2D, 3D, and Augmented Reality and Virtual Reality video games, and allows inexperienced developers to use Bolt Visual Scripting to connect visual nodes to construct the game logic, thus allowing developers to view the C# code, and increase their understanding of C# (Unity Technologies 2021).</p>
  <b>Are there any software licenses needed?</b>
  <p>GameMaker Studio offers three different subscriptions offering different options, including the Free subscription, which grants developers the ability to create games, access to the tutorials and community support, as well as the ability to publish the game via Opera’s GXC; the Indie subscription, which costs $14.50 per month or $139.95 per year, grants developers the same options as the Free subscription, as well as the ability to use the YoYo Compiler, allows developers to add third-party extension to their games, and to publish the game to the Windows, Linux, and macOS platforms, as well as the iOS, Android, Amazon Fire, Android TV, tvOS, and HTML5 platforms; and the Enterprise subscription, which costs $114.95 per month or $1,149.50 per year, grants developers the same option as the previous subscriptions, as well as the ability to access the Command Line Build option, and to publish their games to the PlayStation 4 and 5 platforms, as well as the Xbox One and Series X|S platforms, and the Nintendo Switch platform (YoYo Games 2021).</p>
  <p>Unity offers four different subscriptions offering different options, including the Personal subscription, which grants developers the ability to create their games, and to publish the game to Windows, Mac, and Linux platforms, as well as the iOS, Android, and HTML5 platforms, as well as analytic tools, and Unity ads for mobile games, and an in-app purchase plugin; the Plus subscription, which costs $399 per year, and grants developers all the options available in the Free subscription, as well as advanced cloud diagnostic tools; the Pro subscription, which costs $1,800 per year, and grants developers all the options available in the previous subscriptions, as well as the ability to publish games to the Nintendo, PlayStation, and X-Box platforms, and increased analytic tools; and the Enterprise subscription, which costs $4,000 per month, and grants developers all the options available in the previous subscriptions, as well as technical support (Unity Technologies 2021).</p>
  <p>Unreal Engine offers three different licences offering different options, including the Publishing Licence, which is free to use, however Epic Games will take a 5% royalty when your game reaches $1 million dollars in revenue, and grants the developer all Unreal Engine features, the entire Quixel Megascans library, access to learning material, and community support; and the Custom Licence, where the cost is negotiated between the developer and Epic Games, and grants developers access to all the options offered by the Publishing License, as well as premium support, and private training.</p>
  <b>Is there any hardware needed?</b>
  <p>The recommended hardware for GameMaker Studio 2 is 64-bit OS, either Windows 10 or macOS Catalina, a Quad Core CPU, 8GB RAM, a dedicated graphics card, an SSD with 3GB free disk space, and an internet connection (YoYo Games 2021).</p>
  <p>The recommended hardware for Unity is 64-bit OS, either Windows 7 (SP1+) and Windows 10 or High Sierra 10.13+, a CPU with X64 architecture with SSE2 instruction set support, and a graphic card capable of DX10, DX11, and DX12-capable GPUs (Unity Technologies 2021).</p>
  <p>The recommended hardware for Unreal Engine 4 is Windows 10 64-bit, Quad-core 2.5 GHz CPU, 8 GB RAM, and a DirectX 11 or DirectX 12 compatible graphics card (Epic Games 2021).</p>

  <h3>Testing</h3>
  <p>There are nine different methods to test a video game, and these methods include, Combinatorial testing, which involves checking every possible combination of values for all parameters utilising Category-Partition testing, Pair testing and Catalogue based testing; Clean Room testing, which combines mathematical reasoning, design refinement, and statistical reasoning to produce minimal defect software; Functionality testing, which tests the functions of the software and whether it is working appropriately, to find bugs and errors; Compatibility testing, which involves testing whether the game functions correctly across the different platforms; Tree testing, which involves checking the menu navigation system; Regression testing, which involves re-running previous tests to ensure new features haven’t adversely impacted already added features; Ad-Hoc testing, which involves unplanned error testing utilising Error Guessing techniques; Load testing, which involves determining whether the infrastructure can keep the game running smoothly under real-world load conditions, and at peak user load; and Play testing, which involves getting users to play the game to assess all the non-functional features of the game, such as whether the game is fun to play (Test Bytes 2017).</p>

  <h3>Timeframe</h3>
  <p>This should be presented in the form of a table, with one row for each week, specifying as best you can the work for each person for each week
Since the game will start off with only a single developer, there is a one year expected time frame, just to see some sort of progress, and two to three years just to get to playable state, Alpha phase, maybe Beta phase.  The game will be built up slowly, and in the beginning only the core features, such as enemy AI, bosses, weapon, armour, and accessory loot drops, and then expanding to include new areas which will bring out new bosses and new loot drops.  The expansion patches for the game will likely take 6 months to 1 year to complete.</p>
  ...
  <b>How will your group communicate?</b>
  <p>The main form of communication will be through an online platforms like Microsoft Teams, which allow messages to be exchanged and for calls to be made between a group of people and have more functionality than relying on email alone (Kanell n.d.).  These online platforms offer a range of options like screen sharing, file sharing, personal and group chat, video calls which are important when team members are collaborating on a project and allows for the easy sharing of information between different group members, or to the group as a whole (Yankovsky 2021).</p>
  
  <b>How often will meetings take place?</b>
  <p>A study performed by Steven Rogelberg asked senior managers in a range of industries about meetings, and their results showed that 65% of respondents stated that meetings prevent them form getting work completed, and 71% stated that meetings are unproductive and inefficient (Perlow, Hadley & Eun 2017).  Thus, team meetings are only effective when they timed well, don’t occur too often, and are led by a competent leader (Perlow, Hadley & Eun 2017).</p>
  <p>Group meetings will take place once per week, which was decided based on the availability of the group members.  This will allow the team to prioritize and complete any tasks required.  With that, this will further promote group members to bring forward new strategies and ideas.  Any issues that need to be addressed can be brought to the attention of the team leader, and a personal team meeting can be scheduled to address these issues.</p>
  
  <b>Will these be face-to-face, or using technologies such as Skype?</b>
  <p>The project will be executed through the use of technology; therefore, it is important that communication is kept online too.  With that, the group will communicate through two applications, this being Skype and Microsoft Teams.  This will allow for easy connections to be made amongst group members, as messages can be exchanged, and calls can be made regardless of the devices each person holds.</p>
  
  <b>What will you do if you have a group member who does not respond to communications?</b>
  <p>If a member does not respond to any form of group communication made to them, a personal message will be sent to them to find out and understand why.  With that, any issues that arise will be dealt accordingly, whether it is done through a personal or group meeting. However, if the unresponsive team member does not respond, it will be taken further up to the course convenor.</p>
  
  <h3>Skills and Jobs</h3>
  <h4>Sound Designer</h4>
  <p>We are looking for an experienced and passionate Sound Designer for our upcoming MMORPG project. Alongside with a talented team of developers, you will work on many different aspects of audio content development for the project.</p>
  <b>Duties and responsibilities:</b>
  <ul>
  	<li>Designing and implementing linear and interactive sound assets with tools and scripting logic</li>
  	<li>In-depth real-time audio scripting</li>
  	<li>SFX creation and mastering</li>
  ...
  <ul>
 	...
 	<li>Demonstrated creative and technical achievement in sound design</li>
  	<li>Experience with Audio APIs (Wwise, Fmod, Miles), digital audio workstations, MIDIs, and Max</li>
 	<li>Knowledge of C, C++ or C#</li>
  	<li>A good understanding of software and tool development</li>
  	<li>Experience with audio engineering (editing and mixing), audio production, audio recording </li>
  	<li>A good knowledge of sound libraries</li>
  	<li>Thorough knowledge of PC audio functionality, capabilities, and limitations </li>
  	<li>Good communication skills and the ability to collaborate with the Game Designer, and Video Game Programmer</li>
  ...
  <b>Duties and responsibilities:</b>
  <ul>
	<li>Designing and developing the original concept</li>
	<li>Construct level structure</li>
	<li>Writing plots, storylines, dialogue, and game objectives</li>
	<li>Storyboarding the action of the game</li>
	<li>Conceive every element of the game, including rules, setting, economy, weapons, armour, enemy mobs, NPCs, etc</li>
	<li>Direct action sequences</li>
	<li>Define user interface, menus, and controls</li>
	<li>Develop the Game Design Document</li>
	<li>Develop early prototypes</li>
	<li>Define the user experience</li>
	<li>Lead the development process</li>
	<li>Manage quality assurance testing, and follow up on feedback</li>
  ...
  <ul>
	...
	<li>A strong creative drive, and an analytical mind</li>
	<li>Solid knowledge of the Gaming Industry, and the latest trends</li>
	<li>Good communication skills and the ability to collaborate with the Game Artist, Sound Designer, and Video Game Programmer</li>
	<li>Good leadership skills – managing the production process, scheduling, budgeting, keeping all the team members on time</li>
  ...
  <b>Duties and responsibilities:</b>
  <ul>
	<li>Collaborating with the Game Designer regarding the style and feel of the game</li>
	<li>Researching references and resources required to produce the assets for the game</li>
	<li>Design the key elements of the visual style</li>
	<li>Build 2D models of all assets in line with the visual style</li>
	<li>Applying lighting and shading effects to all elements, ensuring consistency in colour, intensity, and lighting levels</li>
	<li>Animating player characters, NPCs, and enemy mobs</li>
	<li>Designing special effects</li>
	<li>Creating prototypes for testing purposes</li>
  ...
  <ul>
	...
	<li>Experience with GameMaker Studio 2, Unity, or Unreal Engine 4</li>
	<li>Knowledge of either GML, C# or C++</li>
	<li>Comprehensive skills with Adobe photoshop, Illustrator and Affect effects</li>
	<li>Knowledge of key art principles, such as colour, value, and composition</li>
	<li>Good communication skills and the ability to collaborate with the Game Designer, and Video Game Programmer</li>
	<li>Creative drive</li>
	<li>Proficiency in 2D modelling
  </ul>
  ...
  <ul>
	...
	<li>Experience with GameMaker Studio 2, Unity, or Unreal Engine 4</li>
	<li>Exception knowledge of either GML, C# or C++</li>
	<li>Proficiency 2D modelling </li>
	<li>Knowledge of debugging tools</li>
	<li>Knowledge of optimisation principles</li>
...
<b>Karl’s Feedback:</b>
  <p>It was great to be part of this team, everyone participated and did the part with David as our team leader it made our task more efficient to get the project done. We managed to help each other through communications and great leadership.</p>
  ...
  <p>The versatility of Microsoft Teams, especially in its ability to share files, as well as  screen sharing capabilities, allows team meetings to progress smoothly, and allows all team members to be able to view the same document, and address issues as they are raised.</p> 
  
  <b>At least one thing that you have learned about groups.</b>
  <p>Team meetings are a necessity in group projects, however they really only need to be limited to defining the project tasks, and assigning these tasks, as well as the deadline for when these tasks need to be completed.  For most issues, a one-on-one meeting could easily resolve the issue.</p> 
